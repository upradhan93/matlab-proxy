        ...
        <div id="ExistingLicense">
            <form onSubmit={submitForm}>
                <div className='form-group'>                     
                    <p>
                        <b>Note</b>: Choose this option if you already have an activated MATLAB license. This option allows you to run MATLAB on your local machine without providing additional licensing information.
                    </p>
                    <br/>
