...
| **MWI_USE_EXISTING_LICENSE** | string (optional) | `"True"` | When set to `True`, matlab-proxy will not ask the user for additional licensing information and will try to launch an already activated MATLAB on your system PATH. 
